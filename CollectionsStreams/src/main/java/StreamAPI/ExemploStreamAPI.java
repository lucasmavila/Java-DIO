...
public class ExemploStreamAPI {
  public static void main(String[] args) {
    ...
    System.out.println("Maior numeor de letras: " + estudantes.stream().max(Comparator.comparingInt(String::length)));

    // Retorna o elemento com o menor numero de letras
    System.out.println("Menor numeor de letras: " + estudantes.stream().min(Comparator.comparingInt(String::length)));
    ...
    // Retorna true se alguem os elementos possuem a letra a no nome
    System.out.println("Tem algum elemento com a no nome? " + estudantes.stream().anyMatch((elemento) -> elemento.contains("a")));

    // Retorna true se nenhum os elementos possuem a letra a no nome
    System.out.println("Não tem nenhum elemento com a no nome? " + estudantes.stream().noneMatch((elemento) -> elemento.contains("a")));
